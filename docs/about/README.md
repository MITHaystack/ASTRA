...
Joe Lind also earned his stripes as an astronomer, testing in the middle of winter and well below zero, and the heat of summer with heat, humidity, and a lack of shade. 
...
- [Python]() We have been heavy duty python users since 2001! Read-write Lisp for the win.
...
The ASTRA user interface has made use of the Claude Sonnet 4.6 model for initial vibe coding of the astra-ui portion of the code base. This coding was guided by the Nice Vibes AI coding agent guidelines for the python NiceGUI user interface framework. Other code used in ASTRA has been hand developed. All of it has been modified or edited manually. 
