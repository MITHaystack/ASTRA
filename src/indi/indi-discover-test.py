"""
    indi-discover-test.py

    PyIndi test interface from the examples. This is to discover and print the properties of all available indi devices.

    Logging changed over to loguru
...
logger.add("/data/logs/indi-discover-test.log", format="{time:YYYY-MM-DD at HH:mm:ss} | {level} | {message}", rotation="5 MB", backtrace=True, diagnose=True)
