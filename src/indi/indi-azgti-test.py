"""
    ...
    PyIndi test interface for the Skywatcher AzGTI mount.
...
logger.add("/data/logs/indi-azgti-test.log", format="{time:YYYY-MM-DD at HH:mm:ss} | {level} | {message}", rotation="5 MB", backtrace=True, diagnose=True)
...
device = indiClient.getDevice('skywatcher')
